...
class Iconpicker extends Field implements PreviewableFieldInterface
{
	 ...
	 */
	const FONT_DIR = '@vendor/selfinteractive/iconpicker/src/resources-shared/fonts/';
	...
	public function getInputHtml($value, ElementInterface $element = null): string
	{
		...
		// Display the field
		return Craft::$app->getView()->render('@vendor/selfinteractive/iconpicker/src/views/main/_field', [
			'name' => $this->handle,
			'value' => $value,
			'field' => $this,
			'icons' => $this->getIcons(),
